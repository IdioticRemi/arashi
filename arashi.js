...
.add(8, ({ author, client }) => client.guilds.get("517738561420787722").member(author.id) && client.guilds.get("517738561420787722").member(author.id).roles.map(r => ["Helpers", "Moderators"].includes(r.name)), { fetch: true })
